...
use X11::XCB::Window;
use X11::XCB qw(:all);
use lib qw(/home/james/src/i3-radius/build/../../i3-radius/AnyEvent-I3/blib/lib);
use AnyEvent::I3;
...
sub launch_with_config {
    ...
    if ($config ne '-default') {
        ...
        open(my $conf_fh, '<', '/home/james/src/i3-radius/build/../../i3-radius/testcases/i3-test.config')
