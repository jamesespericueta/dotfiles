...
use lib qw(/home/james/src/i3-radius/build/testcases/lib /home/james/src/i3-radius/build/../../i3-radius/testcases/lib /home/james/src/i3-radius/build/../../i3-radius/AnyEvent-I3/blib/lib);
...
my @binaries = qw(
                   /home/james/src/i3-radius/build/i3
                   /home/james/src/i3-radius/build/i3bar/i3bar
                   /home/james/src/i3-radius/build/i3-config-wizard/i3-config-wizard
                   /home/james/src/i3-radius/build/i3-dump-log/i3-dump-log
                   /home/james/src/i3-radius/build/i3-input/i3-input
                   /home/james/src/i3-radius/build/i3-msg/i3-msg
                   /home/james/src/i3-radius/build/i3-nagbar/i3-nagbar
               );
...
my @test_binaries = qw(
                        /home/james/src/i3-radius/build/test.commands_parser
                        /home/james/src/i3-radius/build/test.config_parser
                        /home/james/src/i3-radius/build/test.inject_randr15
                    );
...
$ENV{PATH} = join(':',
    '/home/james/src/i3-radius/build/i3-nagbar',
    '/home/james/src/i3-radius/build/i3-msg',
    '/home/james/src/i3-radius/build/i3-input',
    '/home/james/src/i3-radius/build/i3-dump-log',
    '/home/james/src/i3-radius/build/i3-config-wizard',
    '/home/james/src/i3-radius/build/i3bar',
    '/home/james/src/i3-radius/build',
    '/home/james/src/i3-radius/build/../../i3-radius',
    $ENV{PATH});
...
if (scalar @testfiles == 0) {
    @testfiles = </home/james/src/i3-radius/build/../../i3-radius/testcases/t/*.t> if @testfiles == 0;
} else {
    @testfiles = map {
        # Fully qualify each specified file if necessary
        if (! -e $_) {
            $_ = "/home/james/src/i3-radius/build/../../i3-radius/testcases/$_";
        }
        $_
    } @testfiles;
}
